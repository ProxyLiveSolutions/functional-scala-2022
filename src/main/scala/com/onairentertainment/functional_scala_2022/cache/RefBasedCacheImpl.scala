...
import com.onairentertainment.functional_scala_2022.cache.SimpleCache.{InsertResult, UpdateResult}

private[cache] final class RefBasedCacheImpl[F[_]: Functor, K, V](ref: Ref[F, Map[K, V]]) extends SimpleCache[F, K, V]:
